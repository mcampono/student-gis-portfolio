...
tools:
  ...
  - 3D Analyst
  - Microsoft Excel
image: "images/wilderness-assessment.png"
image-alt: "Map or presentation graphic summarizing the wilderness suitability assessment for Arches National Park."
featured: false
tier: 2
toc: true
toc-depth: 2
...
The surviving materials indicate that the project combined geodatabase preparation, resource-management analysis, cartography, raster modeling, vector analysis, demographic assessment, and 3D visualization to evaluate whether land within or adjacent to **Arches National Park** should be considered for wilderness designation.
...
<!--
Replace the filename below once a representative image has been selected.

![Overview of the Arches National Park wilderness assessment.](images/wilderness-assessment.png){.lightbox group="arches-project" fig-alt="Map or presentation graphic summarizing the wilderness assessment for Arches National Park."}
-->

## Reconstructing the Assignment

The original project prompt is no longer available, so the exact assignment language cannot be reproduced.

The surviving report and presentation make several things clear:
...
<!--
Suggested hydrology image:

![Hydrology and washes within Arches National Park.](images/hydrology.png){.lightbox group="arches-project" fig-alt="Map of perennial and intermittent streams, washes, and the Colorado River near Arches National Park."}
-->
...
<!--
Suggested DEM images:

::: {layout-ncol=2}

![Hillshade and elevation model for Arches National Park.](images/dem-hillshade.png){.lightbox group="arches-project" fig-alt="Hillshade or elevation map created from a mosaic of nine digital elevation models covering Arches National Park."}

![Area represented by different elevation classes.](images/elevation-classes.png){.lightbox group="arches-project" fig-alt="Map or chart showing reclassified elevation categories within Arches National Park."}
...
<!--
Suggested fire model gallery:

::: {layout-ncol=2}

![Slope categories used in the fire-hazard model.](images/fire-slope.png){.lightbox group="arches-project" fig-alt="Reclassified slope categories used in the Arches National Park fire-hazard model."}

![Aspect categories used in the fire-hazard model.](images/fire-aspect.png){.lightbox group="arches-project" fig-alt="Reclassified terrain aspect categories used in the Arches National Park fire-hazard model."}

![Elevation categories used in the fire-hazard model.](images/fire-elevation.png){.lightbox group="arches-project" fig-alt="Reclassified elevation categories used in the Arches National Park fire-hazard model."}

![Final low, medium, and high fire-hazard classes.](images/fire-hazard.png){.lightbox group="arches-project" fig-alt="Final fire-hazard map created by combining slope, elevation, aspect, and vegetation flammability."}
...
<!--
Suggested trail gallery:

::: {layout-ncol=2}

![Trail density within Arches National Park.](images/trail-density.png){.lightbox group="arches-project" fig-alt="Map showing trail density within Arches National Park."}
...
<!--
Suggested campsite image:

![Potential backcountry campsite areas.](images/backcountry-campsites.png){.lightbox group="arches-project" fig-alt="Suitability map identifying potential backcountry campsites based on water access, low slope, distance from infrastructure, and wildlife-viewing opportunities."}
-->
...
<!--
Suggested wildlife gallery:

::: {layout-ncol=2}

![Desert bighorn sheep habitat within the park.](images/bighorn-habitat.png){.lightbox group="arches-project" fig-alt="Map of desert bighorn sheep habitat within Arches National Park."}

![Overlapping chukar and desert bighorn sheep habitat.](images/wildlife-overlap.png){.lightbox group="arches-project" fig-alt="Map showing overlapping chukar and desert bighorn sheep habitat used to identify wildlife-viewing opportunities."}
...
<!--
Suggested transportation gallery:

::: {layout-ncol=2}

![Roads and highways surrounding Arches National Park.](images/regional-roads.png){.lightbox group="arches-project" fig-alt="Map of highways, local roads, and railroad infrastructure surrounding Arches National Park."}

![Combined road density within Arches National Park.](images/road-density.png){.lightbox group="arches-project" fig-alt="Map showing the density of paved and four-wheel-drive roads within Arches National Park."}
...
<!--
Suggested final recommendation image:

![Final wilderness assessment for Arches National Park.](images/wilderness-assessment.png){.lightbox group="arches-project" fig-alt="Final project graphic concluding that neither the existing park nor adjacent land was a preferred candidate for wilderness designation."}
-->
...
The surviving report and presentation identify the team members but do not consistently document which person completed each individual map or analytical section.

For that reason, this portfolio presents the project as a **group product** rather than assigning undocumented individual credit.

My surviving files show that I participated in the project’s data preparation, analysis, documentation, presentation, and geodatabase training, but the exact division of labor cannot be reconstructed with confidence from the available materials.

## Geodatabase Training

The course included Esri Virtual Campus training related to geodatabases.

I remember completing modules covering:
...
<!--
Suggested certificate image:

![Certificate for completing Esri's Basics of the Geodatabase Data Model course.](images/geodatabase-certificate.png){.lightbox group="arches-project" fig-alt="Esri certificate showing completion of Basics of the Geodatabase Data Model on January 14, 2009."}
-->
...
<!--
Add video files after converting or reviewing the original animations.

### Southeast Park Flyover

<video controls width="100%">
  <source src="animations/southeast-flyover.mp4" type="video/mp4">
...
<video controls width="100%">
  <source src="animations/road-flyover.mp4" type="video/mp4">
  Your browser does not support embedded video.
</video>
-->
